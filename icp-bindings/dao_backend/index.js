...
import { idlFactory } from './dao_backend.did.js';
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./dao_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the dao_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./dao_backend.did.js")._SERVICE>}
 */
export const dao_backend = createActor(canisterId);
